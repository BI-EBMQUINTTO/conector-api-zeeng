function onOpen() {
 SpreadsheetApp
   .getUi()
   .createMenu("CONEXÃO API ZEENG")
   .addItem("BUSCAR DADOS", "showAdminSidebar")
   .addToUi();
}
...
/** hasCode calcula uma hash (número inteiro) apartir de uma string
 * @param {str} cadeia de caract
 * @return número inteiro único diferente para cada string
 */
